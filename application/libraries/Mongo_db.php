...
class Mongo_db
{
     ...
     * @return void
     */
    public function __construct($config = 'default', $connect = true)
    {
     ...
     * @return void
     */
    public function setConfig($config = 'default', $connect = true)
    {
        ...
        {
          $this->_configData = array_merge($this->_configData, $this->_ci->config->item($config));
        }
        else
        {
