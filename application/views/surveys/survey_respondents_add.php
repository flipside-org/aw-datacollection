      ...
      <div class="inner">
        ...
        <nav id="secondary" role="navigation">
          <ul class="bttn-toolbar">
            ...
            <li>
              <a href="<?= $survey->get_url_respondents(); ?>" class="bttn bttn-default bttn-medium bttn-icon-cancel">Cancel</a>
            </li>
            <li>
              <a href="#" class="bttn bttn-success bttn-medium bttn-icon-save" data-trigger-submit="respondents_add_submit">Import</a>
            </li>
          </ul>
        </nav>
